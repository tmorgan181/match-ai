    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "advocate", label: "We need to change the systems and rules around AI" },
          { value: "student", label: "We need to understand it better first" },
          { value: "researcher", label: "We need rigorous investigation more than hot takes" },
          ...
          { value: "displaced", label: "AI is threatening people's jobs and futures" },
